...
this.popup.classList.toggle('uc-show')}else{this.popup.classList.toggle('uc-show');setTimeout(()=>{this.popup.style.top=`${10 + chatBtnHeight}px`},600)}}else{if(bounds.top-50<0){this.popup.style.bottom=`-${chatBtnHeight + bounds.height}px`
this.popup.classList.toggle('uc-show')}else{this.popup.classList.toggle('uc-show');setTimeout(()=>{this.popup.style.bottom=`${10 + chatBtnHeight}px`},600)}}}}
